...
The `platform-foundations` pack and DevOps Engineer path include guided labs spanning Linux, Git, containers, Kubernetes, CI/CD, observability, data/CDC, compliance, bare-metal planning, PatchLab-inspired datacenter networking tickets, and multi-skill capstones (incident, payments reliability, compliance release, landing zone).
